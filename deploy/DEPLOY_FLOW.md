...
5.  **Execution**:
    ...
    *   Validator Client installation when Charon is on: `--distributed` for Lighthouse/Nimbus/Lodestar/Prysm; `--Xobol-dvt-integration-enabled=true` and `--Xvalidator-client-beacon-api-executor-threads=50` for Teku.
